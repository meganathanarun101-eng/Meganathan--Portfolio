...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Meganathan R — Full Stack & MERN Developer" },
      {
        name: "description",
        content:
          "Portfolio of Meganathan R, full stack MERN developer and AI enthusiast.",
      },
      { name: "author", content: "Meganathan R" },
    ...
    scripts: [
      {
        ...
        children: JSON.stringify({
          ...
          sameAs: [
            "https://github.com/meganathan-r",
            "https://linkedin.com/in/meganathan-r",
          ],
        }),
      },
    ],
